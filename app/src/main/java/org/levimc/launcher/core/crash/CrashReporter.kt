...
/**
 * Local crash reporting via xCrash. Remote crash reporting (Firebase Crashlytics) has been
 * removed from this fork; the public API below is kept so callers don't need changes, but
 * the remote-reporting hooks are now no-ops.
 */
object CrashReporter {
    ...
    /** No-op: remote crash reporting was removed along with Firebase. */
    @JvmStatic
